        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //NO FUNCIONA, ¿CÓMO SE LO PASO AL LAYOUT PARA QUE ME LO MUESTRE SIEMPRE EN TODAS LAS VISTAS DONDE TENGA EL LAYOUT?
					if (usuario != null)
					{
                        ViewData["Nombre"] = usuario.Nombre;
                        string[] partesApellido = (usuario.Apellidos).Split(' ');
                        ViewData["PrimerApellido"] = partesApellido[0];
